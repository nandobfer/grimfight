...
describe("Item base contracts", () => {
    it("manages tooltip, merge cache, sprite lifecycle, drag, snap, drop, and sync", () => {
        ...
        expect(source).toContain("temporarySource?: \"thiefsgloves\"")
        ...
        expect(source).toContain("applyModifier(_creature: Creature)")
        expect(source).toContain("afterApplying(_characters: Creature[])")
        expect(source).toContain("cleanup(_creature: Creature)")
