...
export class Preloader extends Scene {
    ...
    preload() {
        ...
        MonsterRegistry.preloadVisuals(this)
    ...
    loadExtraSprites() {
        ...
        this.load.spritesheet("freud_attacking", `spritesheets/characters/freud_attacking.png`, { frameWidth: 128 })
    ...
    loadParticles() {
        ...
        this.load.spritesheet("death_particles", "particles/death_particles.png", { frameWidth: 192 })
