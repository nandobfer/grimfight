...
export class AssassinTrait extends Trait {
    name = "Assassino"
    description = "Assassinos ganham {0} chance de acerto crítico e cada assassinato bem sucedido concede {1} para seu multiplicador de dano crítico, permanentemente"
